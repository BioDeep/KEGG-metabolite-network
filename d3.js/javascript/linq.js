...
(function (Internal) {
    var BackgroundWorker = /** @class */ (function () {
        ...
        BackgroundWorker.RunWorker = function (script, onMessage) {
            var url;
        ...
        */
        BackgroundWorker.fetchWorker = function (scriptUrl) {
            // get script text from server
            var script = HttpHelpers.GET(scriptUrl);
            var blob;
            try {
...
var Bootstrap = /** @class */ (function () {
    ...
    Object.defineProperty(Bootstrap.prototype, "currentAppPage", {
        ...
        */
        get: function () {
            return getAllUrlParams().Item("app") || $ts("@app") || "/";
        },
        enumerable: true,
        configurable: true
    });
